...
const ko: Profile2026Copy = {
  ...
  history: "전체 경력 보기", projects: "주요 프로젝트",
...
const th: Profile2026Copy = {
  ...
  history: "ดูประวัติทั้งหมด", projects: "โปรเจกต์ที่คัดสรร",
...
const vi: Profile2026Copy = {
  ...
  history: "Xem toàn bộ quá trình", projects: "Dự án tiêu biểu",
...
const de: Profile2026Copy = {
  ...
  history: "Gesamten Werdegang ansehen", projects: "Ausgewählte Projekte",
