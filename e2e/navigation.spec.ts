...
test.describe("Primary navigation", () => {
  ...
  test("Profile link navigates to /en/profile", async ({ page }) => {
    await page.getByRole("navigation", { name: EN.primaryNavLabel }).getByRole("link", { name: "Profile" }).click();
  ...
  test("site title returns to /en from a section page", async ({ page }) => {
