...
date: 2025-12-03
summary: A deployment flow for fixed and PR-based preview environments, with image caching, desired state, ingress, and TLS kept as separate responsibilities.
