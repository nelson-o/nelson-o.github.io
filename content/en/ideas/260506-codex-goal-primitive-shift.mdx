---
title: Codex `/goal` changes the developer loop
date: 2026-05-06
summary: Codex `/goal` turns agent work from prompt-by-prompt steering into a goal-driven loop with completion defined up front.
---
