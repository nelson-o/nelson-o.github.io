...
This is a digest problem because the answer is not simply "extract common code." The interesting part is the boundary: which decisions should become shared primitives, which decisions should stay in the product application, and which feedback signals prove the package is helping rather than adding ceremony.
...
## What the digest tries to prove
...
The useful output of the digest is a rule of thumb:
