...
date: 2025-09-05
summary: 一張 CI 治理圖，呈現確定性的部署流程如何搭配 OpenTelemetry 支援的 ELK 可觀測性。
...
這種分離讓 GitHub Actions 負責交付，而 OpenTelemetry 與 ELK 成為診斷紀錄。結果是一套 CI 系統：執行保持確定性，診斷則足夠豐富，可以支援 job 層級的可追蹤性、異常偵測、評估與 pipeline 治理。
